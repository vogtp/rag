...
func (_q *CollectionQuery) QuerySources() *SourceSystemQuery {
...
func (_q *CollectionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CollectionQuery) FirstIDX(ctx context.Context) int {
...
func (_q *CollectionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CollectionQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *CollectionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *CollectionQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CollectionQuery) WithSources(opts ...func(*SourceSystemQuery)) *CollectionQuery {
	query := (&SourceSystemClient{config: _q.config}).Query()
...
func (_q *CollectionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Collection, error) {
	...
	for name, query := range _q.withNamedSources {
		if err := _q.loadSources(ctx, query, nodes,
...
func (_q *CollectionQuery) loadSources(ctx context.Context, query *SourceSystemQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *SourceSystem)) error {
...
func (_q *CollectionQuery) WithNamedSources(name string, opts ...func(*SourceSystemQuery)) *CollectionQuery {
	query := (&SourceSystemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedSources == nil {
		_q.withNamedSources = make(map[string]*SourceSystemQuery)
	}
	_q.withNamedSources[name] = query
	return _q
}
